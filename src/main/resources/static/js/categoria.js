...
function cargarCategoria(idItem) {
    $.ajax({
        dataType: 'json',
        url: "http://140.238.185.28:8080/api/Category/" + idItem,
        type: 'GET',
...
function crearCategoria() {
    ...
    $.ajax({
        url: "http://140.238.185.28:8080/api/Category/save",
        type: "POST",
        data: dataToSend,
...
function actualizarCategoria() {
    ...
    datosEnvio = JSON.stringify(data);
    $.ajax({
        url: "http://140.238.185.28:8080/api/Category/update",
        type: "PUT",
        data: datosEnvio,
        contentType: "application/json",
        success: function (response) {
...
function eliminarCategoria() {
    ...
    $.ajax({
        url: "http://140.238.185.28:8080/api/Category/" + dato.id,
        type: "DELETE",
        data: datosEnvio,
        contentType: "application/json",
        success: function (response) {
