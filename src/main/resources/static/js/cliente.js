...
function cargarCliente(idItem) {
    $.ajax({
        dataType: 'json',
        url: "http://140.238.185.28:8080/api/Client/" + idItem,
        type: 'GET',
...
function crearCliente() {
    ...
    $.ajax({
        url: "http://140.238.185.28:8080/api/Client/save",
        type: "POST",
        data: dataToSend,
...
function actualizarCliente() {
    ...
    datosEnvio = JSON.stringify(client);
    $.ajax({
        url: "http://140.238.185.28:8080/api/Client/update",
        type: "PUT",
        data: datosEnvio,
        contentType: "application/json",
        success: function (response) {
...
function eliminarCliente() {
    ...
    datosEnvio = JSON.stringify(client);
    $.ajax({
        url: "http://140.238.185.28:8080/api/Client/" + client.idClient,
        type: "DELETE",
        data: datosEnvio,
        contentType: "application/json",
        success: function (response) {
