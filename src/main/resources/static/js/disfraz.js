...
function autoTraeCategoria() {
	...
	$.ajax({
		url: "http://140.238.185.28:8080/api/Category/all",
		type: "GET",
		datatype: "JSON",
...
function cargarDisfraz(idItem) {
	$.ajax({
		dataType: "json",
		url: "http://140.238.185.28:8080/api/Costume/" + idItem,
		type: "GET",
...
function ingresarDisfraz() {
	if (
		...
		$.ajax({
			url: "http://140.238.185.28:8080/api/Costume/save",
			type: "POST",
			data: dataToSend,
			datatype: "json",
...
function actualizarDisfraz() {
	...
	datosEnvio = JSON.stringify(costume);
	$.ajax({
		url: "http://140.238.185.28:8080/api/Costume/update",
		type: "PUT",
		data: datosEnvio,
		contentType: "application/json",
		success: function (response) {
...
function eliminarDisfraz() {
	...
	$.ajax({
		url: "http://140.238.185.28:8080/api/Costume/" + dato.id,
		type: "DELETE",
		data: datosEnvio,
		contentType: "application/json",
		success: function (response) {
