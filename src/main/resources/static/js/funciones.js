...
function consultarMensajes() {
    $.ajax({
        url: "http://140.238.185.28:8080/ords/admin/message/message",
        type: "GET",
        dataType: "json",
...
function cargarMensaje(idItem) {
    $.ajax({
        dataType: 'json',
        url: "http://140.238.185.28:8080/ords/admin/message/message/" + idItem,
        type: 'GET',
...
function consultarId() {
    ...
    $.ajax(
        { //al link le agregamos / y + el codigo
            url: "http://140.238.185.28:8080/ords/admin/costume/costume/" + codigo,
            type: "GET",
            dataType: "json",
            success: function (json) {
                $("#idDivConsulta").empty();
