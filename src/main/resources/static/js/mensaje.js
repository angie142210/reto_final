...
function autoInicioRelacionCliente() {
	$.ajax({
		url: "http://140.238.185.28:8080/api/Client/all",
		type: "GET",
		datatype: "JSON",
...
function autoInicioCostume() {
	$.ajax({
		url: "http://140.238.185.28:8080/api/Costume/all",
		type: "GET",
		datatype: "JSON",
		success: function (respuesta) {
...
function consultarMensajes() {
	$.ajax({
		url: "http://140.238.185.28:8080/api/Message/all",
		type: "GET",
		dataType: "json",
...
function cargarMensaje(idItem) {
	$.ajax({
		dataType: "json",
		url: "http://140.238.185.28:8080/api/Message/" + idItem,
		type: "GET",
...
function crearMensaje() {
	if ($("#MessageText").val().length == 0) {
		...
		$.ajax({
			url: "http://140.238.185.28:8080/api/Message/save",
			type: "POST",
			data: dataToSend,
			dataType: "JSON",
...
function actualizarMensaje() {
	...
	$.ajax({
		url: "http://140.238.185.28:8080/api/Message/update",
		type: "PUT",
		data: datosEnvio,
		contentType: "application/json",
		success: function (response) {
...
function eliminarMensaje() {
	...
	$.ajax({
		url: "http://140.238.185.28:8080/api/Message/" + dato.idMessage,
		type: "DELETE",
		data: datosEnvio,
		contentType: "application/json",
		success: function (response) {
